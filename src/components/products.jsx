            ...
            <div className='pod'>
                <div className='banner'>
                    <div className='disp-inf'>
                        ...
                        <div className='dwnld'>
                        <Link to='https://play.google.com/store/apps/details?id=com.meesho.supply&pid=pow_website&c=pow&pow_click_page_type=HP&pow_distinct_id=190fa8c4411592-0176d3606fdc6f-26001e51-100200-190fa8c4412cda'><button className='dldbtn'>
