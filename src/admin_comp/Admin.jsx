...
//         <Heading fontSize="32" color="deeppink">
//           {title}
//         </Heading>
//         <Text mt={4} fontweight={800} fontWeight={"bold"}>
//           {desc}
//         </Text>
//       </Box>
//     );
...
//         <Feature title="11 Lakh+" desc="Trust Meesho to sell online" />
//         <Feature title="14 Crore+" desc="Customers buying across India" />
//         <Feature title="19000+" desc="Pincode Supported for delivery" />
//         <Feature title="700+" desc="Categories to sell online" />
//       </Stack>
//     );
//   }
...
//             <img
//               class="img-2"
//               src="https://supplier.meesho.com/images/new-flicker.gif"
//             />
...
//         <StackEx />
//         <div class="block">
//           <h1 class="hdg">Why Suppliers Love Meesho</h1>
//           <p class="para">
...
//               Sellers who don't have a Regular GSTIN too,Meesho fuels growth for
//               all suppliers.
//             </p>
//           </div>
//           <div class="block-2">
...
//             />
//             <a
//               href="https://www.youtube.com/embed/Dx7uwcaDd60?si=XCeSaWeHnXM7fHWq"
...
//             />
//             <a
//               href="https://www.youtube.com/embed/UwZJ31Zv1cQ?si=5JvySvFjrG2iYCSz"
//               title="YouTube video player"
//               frameborder="0"
//               allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
//               referrerpolicy="strict-origin-when-cross-origin"
...
//             <a
//               href="https://www.youtube.com/embed/b6sHjCEmdC4?si=gYCKrz6IeLezJmhp"
//               title="YouTube video player"
//               frameborder="0"
//               allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
//               referrerpolicy="strict-origin-when-cross-origin"
...
//             <div style={{ color: "deeppink", fontSize: "20px" }}>
//               Visit Learning Hub
//             </div>
//           </div>
//         </div>
...
//         <div class="bx">
//           <h1
//             style={{ fontSize: "30px", fontWeight: "bold", marginLeft: "60px" }}
//           >
//             Grow Your Business With Meesho
//           </h1>
//           <div class="section-4">
//             <Card minW="xsm">
//               <CardBody>
...
//                     <span>Mesho Ads</span>
//                     "to be more visible and sell more products. Currently, not
...
//             <div style={{ color: "deeppink", cursor: "pointer" }}>
//               sell@meesho.com
//             </div>
//           </div>
//         </div>
...
//             <input class="styled-3" type="button" value="Start Selling" />
//           </div>
    ...
    <>
      ...
      <div style={{ margin: "0 5%" }}>
        ...
        <div style={{ textAlign: "center", margin: "50px 0" }}>
          <h1 style={{ fontWeight: "bold", fontSize: "30px" }}>
            Sell online to 14 Cr+ customers at
            <span style={{ color: "#f43397", fontWeight: "600" }}>
              {" "}
              0% commission
            </span>
          </h1>
          <p style={{ fontSize: "15px", lineHeight: "26px", margin: "10px 0" }}>
            Become a Meesho seller and grow your business across India
          </p>
          <img
          ...
          <p style={{ fontSize: "15px", lineHeight: "26px", margin: "10px 0" }}>
            You can still sell on Meesho. Click{" "}
            <a
              href="https://supplier.meesho.com/dont-have-gst"
              style={{ color: "#f43397", fontWeight: "600", textDecoration: "none" }}
            >
              here
            </a>{" "}
            to know more.
        ...
        <StackEx />
        <div style={{ float: "left", maxWidth: "460px", margin: "100px 0 -50px 100px" }}>
          <h1 style={{ fontWeight: "bold", fontSize: "28px", lineHeight: "38px", margin: "0 0 10px" }}>
            Why Suppliers Love Meesho
          </h1>
          <p style={{ fontSize: "15px", lineHeight: "26px", margin: "0 0 10px" }}>
            All the benefits that come with selling on Meesho are designed to
            help you sell more, and make it easier to grow your business.
          </p>
        </div>
        <div style={{ display: "flex", flexDirection: "column", margin: "10px 0" }}>
          ...
          >
            <img
              style={{ width: "35px", minWidth: "35px", marginRight: "10px" }}
              src="https://supplier.meesho.com/images/icon-10.svg"
            />
            <div>
              <h1>0% Commission Fee</h1>
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                <img
                  ...
                  src="https://supplier.meesho.com/images/tick.svg"
                />
                <span>Easy Product Listing</span>
              </div>
              <div style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ textAlign: "center", margin: "50px 0" }}>
          <h1 style={{ fontWeight: "bold", fontSize: "30px", marginBottom: "25px" }}>
            How it works
          </h1>
          <div
            style={{
          ...
          >
            <div style={{ flex: "0 1 30%", margin: "10px" }}>
              <div
                style={{
                  backgroundColor: "#fff",
              ...
              >
                <img
                  src="https://supplier.meesho.com/images/how-it-work-1.png"
                ...
                <p style={{ fontSize: "15px", lineHeight: "22px" }}>
                  Register as a Meesho seller and list your products to sell to
                  crores of customers across India
                </p>
              </div>
            </div>
            <div style={{ flex: "0 1 30%", margin: "10px" }}>
              ...
              >
                <img
                  src="https://supplier.meesho.com/images/how-it-work-2.png"
                  style={{ width: "60px", height: "60px", marginBottom: "10px" }}
                />
                <h2 style={{ fontSize: "18px", fontWeight: "600" }}>
                ...
                <p style={{ fontSize: "15px", lineHeight: "22px" }}>
                  Once listed, your products will be available to customers all
                  over India. You can manage orders through our app or website.
                </p>
              </div>
            </div>
            <div style={{ flex: "0 1 30%", margin: "10px" }}>
              ...
              >
                <img
                  src="https://supplier.meesho.com/images/how-it-work-3.png"
                  style={{ width: "60px", height: "60px", marginBottom: "10px" }}
                />
                <h2 style={{ fontSize: "18px", fontWeight: "600" }}>
                  Ship and get paid
                ...
                <p style={{ fontSize: "15px", lineHeight: "22px" }}>
                  Meesho takes care of shipping and logistics. You get paid
        ...
        <div style={{ textAlign: "center", margin: "50px 0" }}>
          ...
          >
            <div style={{ flex: "0 1 30%", margin: "10px" }}>
              ...
              >
                <img
                  src="https://supplier.meesho.com/images/benefit-1.png"
                  style={{ width: "60px", height: "60px", marginBottom: "10px" }}
                />
                <h2 style={{ fontSize: "18px", fontWeight: "600" }}>
                  0% Commission Fee
                ...
                <p style={{ fontSize: "15px", lineHeight: "22px" }}>
                  Keep 100% of your profit by not paying any commission fee.
                </p>
              </div>
            </div>
            <div style={{ flex: "0 1 30%", margin: "10px" }}>
              ...
              >
                <img
                  src="https://supplier.meesho.com/images/benefit-2.png"
                  style={{ width: "60px", height: "60px", marginBottom: "10px" }}
                />
                <h2 style={{ fontSize: "18px", fontWeight: "600" }}>
                  7-Day Payment Cycle
                ...
                <p style={{ fontSize: "15px", lineHeight: "22px" }}>
                  Get your payments within 7 days of order dispatch.
                </p>
              </div>
            </div>
            <div style={{ flex: "0 1 30%", margin: "10px" }}>
              ...
              >
                <img
                  src="https://supplier.meesho.com/images/benefit-3.png"
                  style={{ width: "60px", height: "60px", marginBottom: "10px" }}
                />
                <h2 style={{ fontSize: "18px", fontWeight: "600" }}>
                ...
                <p style={{ fontSize: "15px", lineHeight: "22px" }}>
                  Save on shipping costs with the lowest rates in the market.
                </p>
              </div>
            </div>
          </div>
